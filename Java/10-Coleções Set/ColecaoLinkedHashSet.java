...
//Assim como nas listas temos uma classe linkada, LinkedHashSet
...
class ColecaoLinkedHashSet {
    public static void main(String[] args) {
        // Assim como HashSet não são permitidos elementos duplicados em LinkedHashSet
        ...
        // Em LinkedHashSet ao exibir elementos a ordem de inserção é mantida
