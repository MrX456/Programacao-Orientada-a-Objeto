...
//Podemso usar o Queue em nossas próprias classes
class Consumidor {
    private String nome;
    private String cpf;
...
class ColecoesQueue2 {
    public static void main(String[] args) {
        // Para usar Queue é necessario classe do
        // objeto ter implementado Comparable ou teremos exceção

        Queue<Produto> prod = new PriorityQueue<>();
        prod.add(new Produto("1234", "Notebook Lenovo", 2300.00, 2));
        prod.add(new Produto("4321", "Playstation 4 Slim", 1580.00, 8));
        prod.add(new Produto("2018", "Iphone XR", 7399.00, 0));
        // Classe produto implementa Comparable
